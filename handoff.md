...
- **Historical handoff (superseded):** this record described work before the current user-directed Phase 3 release finalization. Phase 4 is now in progress on top of the released `f1890dd` baseline; see the Phase 4 design, plan, and machine-code verification documents for current status.
